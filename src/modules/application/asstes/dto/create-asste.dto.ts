...
export class CreateAssetDto {
  ...
  @ApiPropertyOptional({ example: 'Sole Owner', description: 'e.g., Sole Owner, Joint Tenants' })
  @IsString()
  @IsOptional()
  ownership_type?: string;

  @ApiPropertyOptional({ example: 'Residential', description: 'e.g., Residential, Commercial' })
  @IsString()
  @IsOptional()
  property_type?: string;

  @ApiPropertyOptional({ example: 450000.00 })
...
export class CreateBulkAssetDto {
  @ApiProperty({ enum: AssetType, example: AssetType.PROPERTY, description: 'Selected once at the top' })
  @IsEnum(AssetType)
  @IsNotEmpty()
  asset_type: AssetType;

  @ApiProperty({ type: [AssetFieldsDto], description: 'List of assets generated via + Add Another button' })
  @IsArray()
  @IsNotEmpty()
